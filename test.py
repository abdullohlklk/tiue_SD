...
class MainPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.samsa_lbl = tk.Label(self,text='Лаваш', font=label_font,
                                  bg='#CD5C5C')
        self.samsa_lbl.place(x=160, y=30,height=25)

        self.samsa_btn1 = tk.Button(self, text='Лаваш обык', font='bold',  bg='#AC1876',
                                  activebackground='#9C7CF4', width=10,
                                  command=lambda: self.basket_ent.insert(0, "Лаваш обык "))
        self.samsa_btn2 = tk.Button(self, text='Лаваш с сыром', font='bold',  bg='#AC1876',
                                  activebackground='#9C7CF4', width=10,
                                  command=lambda: self.basket_ent.insert(0, "Лаваш с сыром "))
        self.samsa_btn3 = tk.Button(self, text='С тыквой', font='bold',  bg='#AC1876',
                                  activebackground='#9C7CF4', width=10,
                                  command=lambda: self.basket_ent.insert(0, "С тыквой "))
        ...
        self.vech_lbl = tk.Label(self,text='Бургер', font=label_font,
                                  bg='#CD5C5C')
        self.vech_lbl.place(x=160, y=100,height=25)
        self.vech_btn4 = tk.Button(self, text='Чиз Буогер+', font='bold',  bg='#AC1876',
                                  activebackground='#9C7CF4', width=10,
                                   command=lambda: self.basket_ent.insert(0, "Чиз Буогер "))
        self.vech_btn5 = tk.Button(self, text='W-бургер', font='bold', bg='#AC1876',
                                  activebackground='#9C7CF4', width=10,
                                   command=lambda: self.basket_ent.insert(0, "W-бургер "))
        self.vech_btn6 = tk.Button(self, text='Пельмени)', font='bold', bg='#AC1876',
                                  activebackground='#9C7CF4', width=10,
                                   command=lambda: self.basket_ent.insert(0, "Пельмени) "))
...
class AdminPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.samsa_lbl = tk.Label(self,text='Официанты', font=label_font,
                                  bg='#CD5C5C')
        self.samsa_lbl.place(x=160, y=30,height=25)

        self.samsa_btn1 = tk.Button(self, text='Официант1', font='bold',  bg='#AC1876',
                                  activebackground='#9C7CF4', width=10,
                                  )
        self.samsa_btn2 = tk.Button(self, text='Официант2', font='bold',  bg='#AC1876',
                                  activebackground='#9C7CF4', width=10,
                                  )
        self.samsa_btn3 = tk.Button(self, text='Официант3', font='bold',  bg='#AC1876',
                                  activebackground='#9C7CF4', width=10,
                                  )
